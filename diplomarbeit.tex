...
\textbf{\large{}Active Protection Jacket}\\
 \vspace{15mm}
 ausgeführt an der\\
 ...
 durch\\
 \vspace{0.5cm}
\textbf{\large{}Dominik Besser}\\
\textbf{\large{}Florian Cart}\\
\textbf{\large{}Murat Cicek}\\
\textbf{\large{}Adrian Friedrich}\\
...
\vspace{20mm}
 ...
 Dr. Dipl. Ing. Ewald Cekan\\
 Dipl. Päd. Johannes Stehlik\\
\par\end{center}
...
(keine Schusterjungen\footnote{siehe \url{http://www.typolexikon.de/s/schusterjunge.html}}
...
sondern eine extrem laienhafte Regel. aus \cite{layout}}. Nach Rücksprache mit dem Betreuer kann auch eine einseitige Variante
...
richtige Lösungen sind in allen Programmen auch ,,leicht`` zu erreichen\footnote{Oder Sie verwenden ein für Ihre Zwecke schlecht geeignetes Programm.}.
\end{itemize}
